...
public:
	...
	bool SetText(const char *text) override { return m_textfield.SetText(text); }
	bool GetText(TBStr &text) override { return m_textfield.GetText(text); }
	...
	TBRect GetPaddingRect() override;
